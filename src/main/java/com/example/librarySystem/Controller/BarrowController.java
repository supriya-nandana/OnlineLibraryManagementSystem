...
public class BarrowController {
	...
	public String barrowBook(@PathVariable("bookId") int bookId,@RequestBody BarrowRequestDto barrowRequestDto) throws InvalidBarrowDateException, MoreBoooksException {
